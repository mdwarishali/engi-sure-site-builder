    ...
    extend: {
      ...
      colors: {
        ...
        enggisure: {
          ...
          tint: "hsl(var(--enggisure-tint))",
          accent: "hsl(var(--enggisure-accent))",
          "accent-light": "hsl(var(--enggisure-accent-light))",
          dark: "hsl(var(--enggisure-dark))",
          warm: "hsl(var(--enggisure-warm))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
